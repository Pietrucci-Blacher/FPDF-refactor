...
class FPDF
{
    ...
    protected bool $iconv;              // whether iconv is available
    protected int|float $k;                  // scale factor (number of points in user unit)
    ...
    protected mixed $DefPageSize;        // default page size
    protected mixed $CurPageSize;        // current page size
    protected int $CurRotation;        // current page rotation
    protected array $PageInfo;           // page-related data
    protected int|float $wPt;
    protected int|float $hPt;          // dimensions of current page in points
    protected mixed $w;
    protected mixed $h;              // dimensions of current page in user unit
    ...
    protected function _UTF8encode($s): bool|string
    {
